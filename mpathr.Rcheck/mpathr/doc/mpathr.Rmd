...
If you want to save the data as a 'csv' to use it in another program, use `write_mpath()`. Once 
written to csv, you can again use `read_mpath()` to read the data back into R.
